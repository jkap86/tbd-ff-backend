...
CREATE INDEX idx_draft_audit_log_draft ON draft_audit_log(draft_id, created_at DESC);
CREATE INDEX idx_draft_audit_log_event ON draft_audit_log(event_type, created_at DESC);
