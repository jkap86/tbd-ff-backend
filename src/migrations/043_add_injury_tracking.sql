...
ALTER TABLE players
ADD COLUMN IF NOT EXISTS injury_status VARCHAR(20), -- 'Out', 'Doubtful', 'Questionable', 'IR', 'PUP', 'Healthy'
ADD COLUMN IF NOT EXISTS injury_designation TEXT, -- Description of injury (e.g., "Ankle", "Hamstring")
ADD COLUMN IF NOT EXISTS injury_return_date DATE, -- Expected return date (nullable)
ADD COLUMN IF NOT EXISTS injury_updated_at TIMESTAMP; -- When injury status last changed
